/*
  ====================================================================================================================================
  Auto SemRush API Extraction by Optimanova (@optimanova)
  ====================================================================================================================================
  Version:      1.2.0
  Copyright:    (c) 2018 by Optimanova.com  
  ====================================================================================================================================

  IMPORTANT: 1) Create $NAME folder manually and set permissions as "Anyone with the Link can View" in Google Drive.  
             2) Run both Cronjobs ($NAME_monthly, $NAME_URLSpreadSheet) before asking for data in spreadsheet.
